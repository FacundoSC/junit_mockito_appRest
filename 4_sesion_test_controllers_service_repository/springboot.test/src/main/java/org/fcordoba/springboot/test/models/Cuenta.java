package org.fcordoba.springboot.test.models;
...
public class Cuenta {
    ...
    public void debito(BigDecimal monto){
        ...
        if(nuevoSaldo.compareTo(BigDecimal.ZERO)<0){
            throw new DineroInsuficienteException("la cantidad de dinero a extraer es superior a la que se tiene en la cuenta");
        }
        saldo = nuevoSaldo;
    }
}
